...
![IVXYD_C52_T3S926_A3_VYT.png](https://i.loli.net/2020/05/10/xCU5VNs74SrqFhG.png)
...
![qq_pic_merged_1589104744760.jpg](https://i.loli.net/2020/05/10/sc9rbUiwYnVumOG.jpg)
...
![0OEC7K_0I8~21N7VX_C___8.png](https://i.loli.net/2020/05/10/CdbI3K2HDjry8hP.png)

**关系模型**：由实体-关系模型转换为相应的数据库建表语言设计的模型称为关系模型。

![FLY_FAP~V77VR7L9O5T65LL.png](https://i.loli.net/2020/05/10/E8i1lZ5dTAHpwsf.png)
...
![P6_39K3_EULWEJW6K6NF__T.png](https://i.loli.net/2020/05/10/f8ioFZSBnpePUYr.png)
...
![qq_pic_merged_1589109587677.jpg](https://i.loli.net/2020/05/10/FHiRjXboNGLEf2y.jpg)
...
- 查询处理器
  ...
  - 包括：
    ...
    ![qq_pic_merged_1589110900512.jpg](https://i.loli.net/2020/05/10/xNKWQMOkEAbluZ4.jpg)
...
![QSO7_5_786_Z_@XS2`V65SH.png](https://i.loli.net/2020/05/11/i1gSZaTDb7Uht4Q.png)
...
​				![Z3`N_AU5L7~AETFKJOS~9AJ.png](https://i.loli.net/2020/05/11/unEjGr5BkfMLsqS.png)

**投影运算：**

​				 **П** A1，A2，...，Ak（r）， П读作pi，A1...Ak都为属性名，r为关系名，其结果保留这些K列的值，并**删除**重复的行。

​				![`_U0`8C9_FYJCJ_QN_@I_HJ.png](https://i.loli.net/2020/05/11/nJN714C2sUtVyZr.png)
...
![KKW_CMD_8W9__3W2IU`BVNC.png](https://i.loli.net/2020/05/11/7dSm9Aen3ytkKbf.png)
...
![D_63I0RN@QFXCUDZ71MQZDA.png](https://i.loli.net/2020/05/11/1z7m92bHdrVZaxu.png)
...
![image-20200511101644485](C:\Users\蒋峻辰\AppData\Roaming\Typora\typora-user-images\image-20200511101644485.png)
...
![qq_pic_merged_1589164186115.jpg](https://i.loli.net/2020/05/11/IRpZHUqT8tVcnw4.jpg)
...
![6G7__5RE@3Q9_IW_ZH_B_SU.png](https://i.loli.net/2020/05/11/jdbMF1J6m4Vzp2E.png)
...
![0ZBU_RJBL_XSIF_CE`2_J_Q.png](https://i.loli.net/2020/05/11/PMIYAgCQZBHj7nK.png)
...
![_LJYJERCMNL3O8035LY__`J.png](https://i.loli.net/2020/05/11/47MD6FsybrKgLRu.png)

![qq_pic_merged_1589167942046.jpg](https://i.loli.net/2020/05/11/14IojYklLyeBdXC.jpg)
...
![O_A_K_SA_5_L`HG_UU5_I_V.png](https://i.loli.net/2020/05/11/rTxU4tiS5JLC8zF.png)
...
![6A3F1WNB_1_U7L~B__M7P94.png](https://i.loli.net/2020/05/11/R6FMgIJL7vyeNl1.png)

![TUZ4___4__D_6_BIU~J`6LU.png](https://i.loli.net/2020/05/11/ipo1YPJTxgf2hbC.png)
...
![5``0PG_VND__0BA_X4_U3AX.png](https://i.loli.net/2020/05/11/DjdAf9rzEtK1n4C.png)
...
- **普通索引：**普通索引是MySQL中基本的索引类型，允许在定义索引的列中插入重复值和空值。
  ...
  - 使用alter table语句创建索引：
    ...
    ```mysql
    alter table exampleTable add index index_name1(bookname(30));
    ```
  ...
  - 使用create index语句创建索引：
    ...
    ```mysql
    create index index_name2 on book(authors);
    ```
...
- **集合的比较:**考虑查询“找出满足下面条件的所有教师姓名，他们工资至少比Biology系某一个教师的工资要高”，在前面，我们将此查询写作：
  ...
  - 上面的例子在SQL中提供另一种方式书写上面的查询。短语“至少比某一个要大”在SQL中可用>some()表示。
    ...
    ![WCTYMPT~C9H2_CE_SCDFEKU.png](https://i.loli.net/2020/05/13/2FgcynRDsIHNdMf.png)
  ...
  - 考虑查询“找出满足下面条件的所有教师的性名，他们的工资比Biology系每个教师的工资的都高”，在SQL中，结构>all对应与词组“比所有的都大”，那么
    ...
    ![T`_IMT___OD@B14W_R_1S_4.png](https://i.loli.net/2020/05/13/uTc8ojRVIDiCrML.png)
...
![SD_X0_7LK__UEFP3LSR6TWS.png](https://i.loli.net/2020/05/16/wdtJTSvxXAuZcal.png)
...
![A_Q@MLP__5_7D_~`SE9~JSA.png](https://i.loli.net/2020/05/17/2MNgALczCKqYEnv.png)
...
![2_QQ1BYCZA2_U_I_4YJ2@PJ.png](https://i.loli.net/2020/05/17/ANfLHJZtp1u6wIG.png)

![HEX@YSL_1_W2L_0X_EMSZ_W.png](https://i.loli.net/2020/05/17/XgoyeR9TtZSrcdC.png)
...
![_CR2B_9X_5@_Z_BJGIP_R85.png](https://i.loli.net/2020/05/17/Cu24aAIovJMBpZt.png)
...
![AIYOJ7K7YIYRM_D82L`__~A.png](https://i.loli.net/2020/05/17/wp4WG75nmbdAqz9.png)
...
![Q@1_AV__7AH1F0`T`CN_1_L.png](https://i.loli.net/2020/05/17/M9ubg8WSc3KvtFh.png)

![U2BDR6XF2_PT13RPX_DP8UX.png](https://i.loli.net/2020/05/17/7hl9JtOXpKwEGMN.png)
...
- <font color = red>双线</font>实体集中的每个实体都至少参加了联系集中的一个联系
  ...
  ![J3SSO46NIJQN`28M_`_Z@CJ.png](https://i.loli.net/2020/05/17/tmpqIbDYXHCn4fW.png)

- <font color = red>带箭头的线段</font>表示被箭头指向的实体集中的实体对另一个实体集中的实体是一对多的联系

  如下图就是一种一对多的联系：

  ![3_T`4S_~LTF_4_D96_EMIHG.png](https://i.loli.net/2020/05/17/HTXWIcqZ9KPuYOM.png)
...
- <font color = red>复合或多值属性</font>
  ...
  <img src="https://i.loli.net/2020/05/17/he4xpZQrBNRjVtk.png" alt="PMTL5CO_KKL_F0J_`_41CPC.png" style="zoom:50%;" />
...
![ECCTULA0_D0V_`A_T_ENVP7.png](https://i.loli.net/2020/05/17/stHzVXSLOqmaJdU.png)
...
- 特化用从特化实体指向另一方实体的空心箭头来表示。这种关系为ISA关系，代表“is a”（是一个）。例如，一个教师“是一个”雇员
  ...
  <img src="https://i.loli.net/2020/05/17/1yzeASM8qNY7Pxn.png" alt="K_YSLJ8N@_82SX99G7OBJKW.png" style="zoom:50%;" />

这个图也可以这么画（老版画法）：

<img src="https://i.loli.net/2020/05/17/uwiZo6kOEJYIr7a.png" alt="4_4ADM5K_TRS2Y73_0~ZE@Q.png" style="zoom: 50%;" />
...
<img src="https://i.loli.net/2020/05/17/IkgbPm8cVsfAWSK.png" alt="_U___OMMMV~YKB19@YSBE53.png" style="zoom:50%;" />

<img src="https://i.loli.net/2020/05/17/XHpQoSvFJZ4jUIM.png" alt="H5_M_2T4S_FXVRM__06J32I.png" style="zoom:50%;" />

**老版：**

<img src="https://i.loli.net/2020/05/17/fTu8WvVpDdyw4bt.png" alt="3I`TBIAT02AQ1V0_E_Z_UEE.png" style="zoom:50%;" />
...
![I5T6SIB0IGP081_RPG_6_P0.png](https://i.loli.net/2020/05/17/dBNwrx6VvYARL34.png)

![DVCB67S6KTHV__E8YON~X`T.png](https://i.loli.net/2020/05/17/zkXjOtVCsbnHPyf.png)
...
- **选择实体集还是联系集：**
  ...
  - 选用联系集后应该考虑映射基数的影响。如，当一个客户在一个分支机构有多个贷款账户，那么就会影响E-R图的设计
    ...
    ![_EG3CGGER_XC7Q_9SWRGCN1.png](https://i.loli.net/2020/05/17/P3vXRbwZNBQjM1D.png)

- 用实体属性还是用联系

  - 比如student(sid,name,sex,age,...,supervisor-id,supervisor-name,supervoisor-position,...,class,monitor)

  - 这时就应该从对象的独立性和减少数据冗余（下一章）考虑
...
4. **E-R图：**
   ...
   ![F61BZD0HE6~_V7~KX_YDV_A.png](https://i.loli.net/2020/05/17/4AKMjadzVrhnvRq.png)
...
- 强实体集转换到具有相同属性的表
  ...
  <img src="https://i.loli.net/2020/05/17/aD4Ul69KE8osGpA.png" alt="D03Q~O_9LD_GQDZN6NUBEZQ.png" style="zoom: 33%;" />
...
- 弱实体集转换成的表还包含对应于其标识强实体集的主键的列(外键)
  ...
  <img src="https://i.loli.net/2020/05/17/o7uYLBvJz1ltc5x.png" alt="LR5429G`QGQE1E_MZ_CJ0_E.png" style="zoom: 33%;" />
...
- 特化表示成表
  ...
  - 方法一：
    ...
    - 为每个低层实体集构造表，包括高层实体集的主键和局部属性
      ...
      <img src="https://i.loli.net/2020/05/17/i5wrVamyknHNLCd.png" alt="GU1D`S6NBAK_7_5HHV6_FSA.png" style="zoom:50%;" />
  ...
  - 方法二：
    ...
    - 为每个实体集构造表，其属性包括所有局部属性和继承来的属性
      ...
      <img src="https://i.loli.net/2020/05/17/BryZpk9sJhAoV1a.png" alt="_G4~F4QEFXFX4O12H_A_LF1.png" style="zoom:50%;" />
...
![V~MIXB@9_N_`05_L@D7W_RF.png](https://i.loli.net/2020/05/17/yAf6mrT8pD4d5Hs.png)
...
- 数据冗余
- 插入，删除，修改异常（数据的不一致）
- 假设我们是脑瘫，我们在设计数据库时不太清醒，我们将instructor模式和department模式结合到了一起，用inst_dept(ID,name,salary,dept_name,building,budget)代替了前两个模式。（我估计凡是懂点面向对象设计的正常人就不能把这两个放在一块，但为了例子还是这么做了）
  - 这就会导致很多的问题，如：
    ...
    - 插入/删除异常，存储一个还不知道所在系的教师信息，要用null来表dept_name,building,budget，这样是行，但是同样null值是难以处理的
    - <img src="https://i.loli.net/2020/05/18/zT3IEqWt6pPA1iG.png" alt="GPLLG8`UFC0_~Z~UJ0K9_A6.png" style="zoom:33%;" />



​	所以综上所述，我们不是时刻都能保证头脑清醒的设计出一个“好”的关系模型，那么万一我们设计出了上面的关系模型怎么办？这就需要有一套理论体系来确保和解决我们设计的“坏”的关系模型转变成“好”的设计模型（并不是说不符合这一套理论的“坏”的设计模型就一定坏，有时我们需要根据实际出发，但这一套理论体系确实提供了参考性，也是挺重要的）
...
- 关系范式理论
- 模式分解理论
- <img src="https://i.loli.net/2020/05/18/pnXHeFwZQdOhvKN.png" alt="RIZDN3CRZ7X_5HC@TCGB_G8.png" style="zoom: 33%;" />
...
​	设R是一个关系模式，并且有属性集a⊆R，b⊆R使得<font color = red>函数依赖a→b</font>在R上成立，当且仅当对任意合法关系r（R）（这里说的就是关系R上的元组昂），若r的任意两条元组t1和t2在属性集a上的值相同，则它们在属性集b上的值也相同。即t1[a] = t2[a]   =>  t1[b] = t2[b]，称之为b函数依赖于a，a函数决定b。

在关系模型设计的时候，我们不仅仅是需要一个对象中的属性，我们还需要这些属性之间的的函数依赖(比如说student的sid能够决定sname)

<img src="https://i.loli.net/2020/05/18/dvSra3DxscLU854.png" alt="_C_KX_A2R`R7C6_2VLV@@_3.png" style="zoom:50%;" />

如上图，α→β，

<img src="https://i.loli.net/2020/05/18/qbN7ID1k9xRHXuK.png" alt="_CEPA0_3_9CW_X_6Q_IN_P9.png" style="zoom:50%;" />
...
- ![CX7_KXE_B__4CX_LU~_L_Q0.png](https://i.loli.net/2020/05/18/xY4D6lrnvwVWy2Z.png)
...
- **原子：**如果某个域中元素被认为是不可分的，则这个域称为**原子的**
  ...
  - 非原子域的例子：复合属性（名字集合）,多值属性（电话号码）
    ...
    <img src="https://i.loli.net/2020/05/19/z6WFGkfaivxpuyj.png" alt="ZYQW9`0C2_A_2588XX_CNY5.png" style="zoom: 50%;" />
...
- 注意哈，在2NF中，不是说仅仅候选键能够决定整个R的所有属性那么简单，而是说其它的**非主属性**<font color = red>完全依赖</font>于候选键
...
- **检查是否为BCNF的方法**
  ...
  - **BCNF分解的算法**
    ...
    - 例，对class(course_id,title,dept_name,credits,sec_id,semester,year,building,room_number,capacity,time_slot_id)
      ...
      分解：因为第一个函数使得R不是BCNF，那就从它开干，根据(result - Ri)∪(Ri - β)∪(α，β)
...
- 例，R = (J,K,L) F = {JK → L,L → K}
  ...
  **有冗余？**有，下图的L和K存在大量冗余，J中还存在null值
  ...
  <img src="https://i.loli.net/2020/05/19/nG4aVIT3qswP71D.png" alt="B89GWTF_999_W_~4_@DYIX2.png" style="zoom:33%;" />
...
- 下图是关于计算机是如何组成存储体系的
  ...
  <img src="https://i.loli.net/2020/05/20/zEcPdmB3MiaYGxq.png" alt="V21_7MN_YUTY___UCE~ZRPG.png" style="zoom:33%;" />
...
- 文件分配表：对应文件的每一个存储块都有一个表项相对应，该表相存储一个数值代表着下一个需要访问的数据块的位置。(然而文件的第一个磁盘块的存储并不在文件分配表中，一般都会在目录和文件夹中隐藏的表名存储的位置)
  ...
  <img src="https://i.loli.net/2020/05/20/GmgLBAnfNVUEwrJ.png" alt="_08SV~_OQ~_4D4YX__5ZOQQ.png" style="zoom:33%;" />
...
- 当主存的页面被占满时，操作系统需要有一定的策略来替换主存中的页面（具体学习操作系统）
  ...
  <img src="https://i.loli.net/2020/05/20/HpfYPeuIzDRkUc9.png" alt="X_Q8__5P4@ZZJU_9_3__S3G.png" style="zoom:33%;" /> 

#### 磁盘的结构与特性:

- 磁盘主要由盘面（磁道和扇区构成）、读写臂、磁头、主轴构成

  <img src="https://i.loli.net/2020/05/20/uPjt9CpgeAX2D3n.png" alt="U65X__1PU1BJF@RKHKG_V_2.png" style="zoom:40%;" />
...
- 操作系统中的文件分配表记录着磁盘块与文件的关系，数据库系统会让操作系统把自己定义的表作为文件后，并让操作系统先为该文件分配若干的磁盘块（这些磁盘块都是空的，让操作系统预先为数据库系统占位置）

- 当我们要读写数据的时候，需要在内存中进行读写，因此内存中的内存页与磁盘块就需要相应的映射。当数据不在内存中时，内存的缓冲区管理就会根据我们已经规定好的索引来找到相应的磁盘块进行交换数据。

  <img src="https://i.loli.net/2020/05/20/CJ2EhTzwc8LMNDI.png" alt="_B~IN___1_KTB_06KQC3DI9.png" style="zoom:33%;" />

  <img src="https://i.loli.net/2020/05/20/1myJYobABUk85N4.png" alt="8PX7~A__GBH35LGQWSP@G_G.png" style="zoom:33%;" />
...
- **数据库-表所占磁盘块的分配方法：**
  - 连续分配：数据块被分配到连续的磁盘上（会出现难以扩展的问题）
  - 链接分配：数据块中包含指向下一个数据块的指针（简单扩展，但是访问速度会出现问题）
...
- **文件组织方法之一：无序记录文件（堆文件）：**
  ...
  - 记录方法2：在前者的基础上，新增记录可以利用那些标记为“删除”的记录空间
    ...
    <img src="https://i.loli.net/2020/05/20/UZxE3oWiTzyuPYb.png" alt="_Q3~LML__AKZJ~L11_T_3O8.png" style="zoom:33%;" />
...
- **文件组织方法之二：有序记录文件（排序文件）：**
  ...
  - 特点：记录按某属性或属性组值得顺序插入，磁盘上存储得记录是有序得。检索效率可能高。
    ...
    <img src="https://i.loli.net/2020/05/20/v7FKlwUsI93HxeR.png" alt="TZ___ZAU0915___2_9T_GP0.png" style="zoom:33%;" />
...
- **文件组织方法之三：散列文件：**
  ...
  - **散列字段和散列码：**用于进行散列函数计算的属性通常称为**散列字段**，散列字段通常也采用关系中的主码，所以又称**散列码**。
    ...
    <img src="https://i.loli.net/2020/05/20/I9vDymXWUrn6cPq.png" alt="A8XHB3RJFP~5J5__I_U@_GB.png" style="zoom:33%;" />

  - 碰撞问题：当不同的记录被散列为同一桶号，这时该记录就按顺序存储在该桶中。检索时，也同样需要在桶内顺序检索某一记录

  - 扩展问题：当由于碰撞到一定程度时，桶中的空间已经被占满，这是就需要对桶进行扩展。最简单的办法是使用链接发处理溢出问题，将已经被塞满的桶中置入一个指向溢出记录的指针，该指针指向溢出桶中的溢出记录。

    <img src="https://i.loli.net/2020/05/20/SdvzQMnGER2VkjX.png" alt="_X`_3SIL60B6`VL_XGQK7RR.png" style="zoom:33%;" />
...
- **文件组织方法之四：聚簇文件**
  ...
  - 多表聚簇：将若干个相互关联的Table存储于一个文件中，这样可以提高多表情况下的查询速度
    ...
    <img src="https://i.loli.net/2020/05/20/rl7z4MGV2FJd6Of.png" alt="CQ@X____P_Z1NI_@K7`P_NF.png" style="zoom:33%;" />
...
- 存储索引项的文件为**索引文件**，相应的，存储表又称为**主文件**。
  ...
  <img src="https://i.loli.net/2020/05/20/qenRu2K4LJ91i8M.png" alt="Q5K24GGH~H78X`K_W_M6F_J.png" style="zoom:33%;" />
...
- **稠密索引：**对于主文件中的每一个记录都会形成一个索引与它对应，指明该记录所在的位置。这样的索引称为稠密索引
  ...
  - 对**非候选键属性**的稠密索引，索引文件中的索引字段值**若是不重复**的，因此为了方便索引查找，主文件必须要按照被索引字段排序并且索引字段不是候选键。（让属性值相同的元组物理存储上相邻）

    若有重复的，那么针对主表中的每一个记录都会有索引相对应

    <img src="https://i.loli.net/2020/05/20/KWL9s6gApuwDTY5.png" alt="MB5EV9_~2_K__K_O_DYN__K.png" style="zoom: 25%;" />

- **稀疏索引：**对于主文件中部分记录形成相应的索引。这样的索引称为稀疏索引。对于稀疏索引，主文件必须是按对应索引字段属性排序存储

- **主索引：**通常是对每一存储块有一个索引项，索引想的总数和存储表所占的存储块数目相同，存储表的每一存储块的第一记录也成为锚记录；同时，组索引是按索引字段进行排序的一个有序文件（一种稀疏索引）

  <img src="https://i.loli.net/2020/05/20/s2a5cg7YxzWPRTl.png" alt="__CJ2UL3F1XHJ~_JG39NMV0.png" style="zoom:33%;" />

  

- **辅助索引：**定义在主文件的任意或多个非排序字段上的辅助存储结构。（辅助索引是一种稠密索引）

  <img src="https://i.loli.net/2020/05/20/HMdBKQnNIwofkzU.png" alt="T5VNXMYDKNY_BVI3SC2_Q6Y.png" style="zoom: 25%;" />

  一个文件仅可以有一个主索引（通常建立在主码/排序码智商），但可以有多个辅助索引（辅助索引的原记录可以不按顺序）

- **聚簇索引：**是指索引中邻近的记录在主文件中也是临近存储的；聚簇索引通常是对局促字段上的每一个不同值都有一个索引项，一个主文件只能有一个聚簇文件。

  <img src="https://i.loli.net/2020/05/20/TOdnUqG3LIDMpNF.png" alt="RV@0ZLMB_RCGW61N_M4Q@2I.png" style="zoom:25%;" />

  主索引与聚簇索引十分相似，甚至主索引通常就是聚簇索引，但是主索引的总数不是由主文件上不同的聚簇值决定的，而是由主文件的存储块决定；

- **多级索引：**B/B+索引是多级索引中最常见的一种。当索引项比较多时，可以对索引再建立索引，依次类推，形成多级索引；而对于B/B+索引实际上是数据结构中的相关概论，具体感兴趣可以自己查。

  <img src="https://i.loli.net/2020/05/20/hGv1OHpMasLCZnu.png" alt="GW90LZ_T_XN_XFFON_IQQ2K.png" style="zoom:25%;" />

- **散列索引：**使用散列技术组织的索引。

  <img src="https://i.loli.net/2020/05/20/alDjIEh7dsSPcF1.png" alt="_7_HHX4V5U80__KT0_B25`S.png" style="zoom:25%;" />
...
- 执行优化：存取路径和执行算法的选择与执行次序的优化；
  ...
  <img src="https://i.loli.net/2020/05/21/M1wbJc9osD6uVxp.png" alt="ZN0_8_3_J5~GKG5_Y9U_MIX.png" style="zoom:25%;" />
...
<img src="https://i.loli.net/2020/05/21/Zp4otWxkB1iYwq7.png" alt="U_AM7G_2MCJF2LRZ@D~0KJ1.png" style="zoom:25%;" />

<img src="https://i.loli.net/2020/05/21/iFA6L38XeCWtPGV.png" alt="__IHYHKK29MM__WGYQUS_AM.png" style="zoom:25%;" />

<img src="https://i.loli.net/2020/05/21/qJjRnXhIKegdErz.png" alt="_Y_FG3K__E5_UKV_RT6_G7K.png" style="zoom:25%;" />

<img src="https://i.loli.net/2020/05/21/rbC1EXWM7mhyPz3.png" alt="XSU6X__C6L~___M_BRMF0HW.png" style="zoom:25%;" />
